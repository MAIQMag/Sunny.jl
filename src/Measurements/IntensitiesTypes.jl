...
struct BandIntensitiesDevice{T, Q <: AbstractQPoints, D} <: AbstractIntensities
    # Original chemical cell
    crystal :: Crystal
    # Wavevectors in RLU
    qpts :: Q
...
struct IntensitiesDevice{T, Q <: AbstractQPoints, D} <: AbstractIntensities
    # Original chemical cell
    crystal :: Crystal
    # Wavevectors in RLU
    qpts :: Q
...
Intensities(device::IntensitiesDevice) = Intensities(device.crystal, device.qpts, device.energies, Array(device.data))
