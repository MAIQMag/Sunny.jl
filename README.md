...
Browse the [Tutorials](https://sunnysuite.github.io/Sunny.jl/stable/examples/01_LSWT_CoRh2O4). For traditional spin wave theory, jump to the [SpinW ports](https://sunnysuite.github.io/Sunny.jl/stable/examples/spinw/SW04_Frustrated_square.html).

Julia setup is described in the [Getting Started](https://github.com/SunnySuite/Sunny.jl/wiki/Getting-started-with-Julia) guide.
...
Say hello on [our Slack workspace](https://join.slack.com/t/sunny-users/shared_invite/zt-1otxwwko6-LzPtp7Fazkjx2XEqfgKqtA). Ask questions on the `#helpdesk` channel.
